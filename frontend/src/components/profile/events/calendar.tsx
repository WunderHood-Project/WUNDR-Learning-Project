...
import {
  ...
  startOfMonth, startOfWeek, compareAsc,
} from "date-fns";
import { Clock, ChevronLeft, ChevronRight } from "lucide-react";
import type { EventForCalendar } from "@/types/event";
import { combineLocal } from "../../../../utils/formatDate";

type Props = { events: EventForCalendar[]; onPick: (eventId: string) => void };
...
export default function EventCalendarIOS({ events, onPick }: Props) {
                    ...
                    {days.map(({ date, inMonth }) => {
                        ...
                        return (
                            <div
                                ...
                                list.length ? "bg-wonderleaf/3 cursor-pointer hover:bg-wonderleaf/5" : ""
                                ].join(" ")}
                            >
                                {/* day number */}
