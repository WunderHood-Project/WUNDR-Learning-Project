...
export default function CardsView({
    ...
    return (
        ...
        {/* MOBILE: all events one under another, no arrows */}
        <div className="md:hidden">
            <div className="grid grid-cols-1 gap-4 sm:gap-5">
                {pool.map(event => (
                    ...
                    onToggleEdit={() =>
                        setEditingId(editingId === event.id ? null : (event.id ?? null))
                    }
                    childById={childById}
