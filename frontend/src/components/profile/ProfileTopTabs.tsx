...
import {
  FaUser, FaChild, FaCalendarCheck, FaBell, FaEllipsisV, FaTrash,
} from 'react-icons/fa';
...
export function ProfileTopTabs({
  ...
  return (
    <div className={`sticky top-0 z-10 bg-wonderbg/80 backdrop-blur supports-[backdrop-filter]:bg-wonderbg/60 ${className}`}>
      {/* ===== один относительный контейнер для бара + линии + спейсера ===== */}
      <div className="relative">
        {/* Бар с табами — выше линии */}
...
"
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    // 'w-9 h-9 md:w-auto md:h-auto md:px-3 md:py-2 lg:px-6 lg:py-2.5', // ← меньше на мобиле
                ...
                >
                  ...
                  <span
                    className={`
                        ...
                        bottom-full mb-2                /* ← вместо top: ставим над кнопкой */
                        whitespace-nowrap rounded-md px-2 py-1 text-xs font-semibold
                        text-white bg-wondergreen shadow z-20  /* поверх всего */
        ...
        {/* Абсолютная оранжевая линия: на всю ширину, ближе к табам, кликам не мешает */}
        <div
          aria-hidden
          className="
            pointer-events-none
        ...
        {/* Спейсер (держит место под линию, чтобы контент снизу не прыгал) */}
