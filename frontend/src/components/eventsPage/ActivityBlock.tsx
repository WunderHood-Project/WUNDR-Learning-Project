...
interface Props {
  ...
  onProgramParticipantCountChange: (programId: string, participants: number) => void;
...
export default function ActivityBlock({
  ...
  onDeleteEvent,
  onDeleteProgram,
  onProgramParticipantCountChange,
  showPastButton,
  showPastEvents,
  onTogglePastEvents,
          ...
          {events.length > 0 || programs.length > 0 ? (
              ...
              {sortedPrograms.map((program) => (
                ...
                >
                  <ProgramCard
                    ...
                    onParticipantCountChange={onProgramParticipantCountChange}
                  />
                </div>
              ))}
            </>
            ...
            <div className="snap-start w-[300px] sm:w-[320px] lg:w-[340px] flex-shrink-0 rounded-2xl border-2 border-dashed border-gray-300 bg-white p-10 text-center shadow-sm">
              <p className="text-base md:text-lg font-semibold leading-snug text-gray-700">
                Our upcoming programs and events schedules are being finalized.
              </p>
