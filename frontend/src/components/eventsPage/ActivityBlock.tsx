    ...
    <section className="mb-16">
      ...
      >
        {events.length > 0 ? (
          ...
          //   </p>
          // </div>
          <div className="snap-start w-[300px] sm:w-[3200px] lg:w-[340px] flex-shrink-0 rounded-2xl border-2 border-dashed border-gray-300 bg-white p-10 text-center shadow-sm">
