export default function PartnerFAQ() {
  const faqs = [
    {
      q: "Are you a 501(c)(3)?",
      a: "YeYes. WonderHood Project is a 501(c)(3) public charity. Donations may be tax-deductible and we provide thank-you letters and impact summaries for your records.",
    },
    {
      q: "Insurance & waivers?",
